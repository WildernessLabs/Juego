...
namespace Juego.Games
{
    ...
    {
        Buffer1 frogUp, frogRight, frogLeft;
        Buffer1 logDarkLeft, logDarkRight, logDarkCenter;
        Buffer1 crocLeft, crocCenter, crocRight;
        Buffer1 truckLeft, truckCenter, truckRight;
        Buffer1 carLeft, carRight;
        ...
        void InitBuffers()
        {
            ...
            frogUp = (new Buffer1(8, 8, frogU)).Rotate(RotationType._90Degrees);
            frogLeft = (new Buffer1(8, 8, frogL)).Rotate(RotationType._90Degrees);
            frogRight = (new Buffer1(8, 8, frogR)).Rotate(RotationType._90Degrees);
            ...
            logDarkLeft = (new Buffer1(8, 8, logDarkL)).Rotate(RotationType._90Degrees);
            logDarkCenter = (new Buffer1(8, 8, logDarkC)).Rotate(RotationType._90Degrees);
            logDarkRight = (new Buffer1(8, 8, logDarkR)).Rotate(RotationType._90Degrees);
            ...
            crocLeft = (new Buffer1(8, 8, crocL)).Rotate(RotationType._90Degrees);
            crocCenter = (new Buffer1(8, 8, crocC)).Rotate(RotationType._90Degrees);
            crocRight = (new Buffer1(8, 8, crocR)).Rotate(RotationType._90Degrees);
            ...
            truckLeft = (new Buffer1(8, 8, truckL)).Rotate(RotationType._90Degrees);
            truckCenter = (new Buffer1(8, 8, truckC)).Rotate(RotationType._90Degrees);
            truckRight = (new Buffer1(8, 8, truckR)).Rotate(RotationType._90Degrees);

            byte[] carL = { 0x1c, 0x3f, 0x4c, 0x4c, 0x4c, 0x3f, 0x1c, 0x00 };
            byte[] carR = { 0x1c, 0xfe, 0x71, 0x71, 0x71, 0xfe, 0x1c, 0x00 };

            carLeft = (new Buffer1(8, 8, carL)).Rotate(RotationType._90Degrees);
            carRight = (new Buffer1(8, 8, carR)).Rotate(RotationType._90Degrees);
        }
